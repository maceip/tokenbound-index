<script lang="ts">
  ...
  import { TriangleSkewSpin } from "svelte-spins";
  let color = "#FBE9E8";
...
{#await objects}
	<li><div style="height: 350px;">
		<TriangleSkewSpin {color} /></div></li>
{:then result}
	<Nft value={result} {tokenAddress} {tokenID} {account} {etherscanURL} />
{:catch error}
	<li>
